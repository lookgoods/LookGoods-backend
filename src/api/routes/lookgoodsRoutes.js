...
export default app => {
	...
	app.route('/currentuser/ownpostlist/pages/:pid')
	...
	app.route('/currentuser/savepostlist/pages/:pid')
	...
	app.route('/currentuser/comments/pages/:pid')
